...
struct Reservoir {
	...
	double gamma, *mask, **train_node, **test_node, *target_train, *target_test, *weight, *input_train, *input_test, *output_train, *output_test, input_signal, input_MZM, input_MZM_phi, NMSE_train, NMSE_test, nyu;
};
